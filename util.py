...
Original file is located at
    https://colab.research.google.com/drive/17V3nKobIF4VT1UCJqs1-iArjIKQg9ZUi
"""
...
def get_kelly(returns, window=10, r=0.02, correlation=False):
    ...
    if correlation:
        roll_cov = returns.expanding(10).cov()
